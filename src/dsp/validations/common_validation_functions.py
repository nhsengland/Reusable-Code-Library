...
from dsp.validations.validation_rules import _RulePrecondition
...
from nhs_reusable_code_library.resuable_codes.spark_helpers import normalise, all_conditions, chain_joins
from dsp.validations.common import DateDelta
from dsp.validations.validation_rules import DASHED_YYYYMMDD, ValidationRuleType, ValidationRule
...
from dsp.datasets.definitions.csds.submission_constants import \
    CYP000 as CSDS_Header_Table, Metadata as CSDS_Metadata, CYP001 as CSDS_Table_001, CYP101 as CSDS_Table_101
from dsp.datasets.definitions.csds.submission_constants import \
...
from dsp.datasets.definitions.iapt.submission_constants import \
    IDS000 as IAPT_Header_Table, Metadata as IAPT_Metadata, IDS001 as IAPT_Table_001, IDS101 as IAPT_Table_101
from dsp.datasets.definitions.iapt.iapt_v2_1.submission_constants import \
...
from dsp.datasets.definitions.mhsds.mhsds_v5.submission_constants import \
    MHS000 as MHSDS_V5_Header_Table, Metadata as MHSDS_V5_Metadata, MHS001 as MHSDS_V5_Table_001, \
    MHS101 as MHSDS_V5_Table_101
...
def get_tables_by_dataset(dataset: str, table_type: str):
    constants = {
        DS.CSDS: {"header_table": CSDS_Header_Table, "metadata": CSDS_Metadata, "table_001": CSDS_Table_001,
                  "table_101": CSDS_Table_101},
        ...
        DS.IAPT: {"header_table": IAPT_Header_Table, "metadata": IAPT_Metadata, "table_001": IAPT_Table_001,
                  "table_101": IAPT_Table_101},
        ...
        DS.MHSDS_V5: {"header_table": MHSDS_V5_Header_Table, "metadata": MHSDS_V5_Metadata,
                      "table_001": MHSDS_V5_Table_001, "table_101": MHSDS_V5_Table_101},
...
def is_valid_procedure_and_procedure_status_code_rule(code: str, scheme_field: TableField, code_field: TableField):
    ...
    return ValidationRule(code, scheme_field.table.name,
                          lambda: ProPlusStatusCodeIsValid(col(scheme_field.qualified_name), col(code_field.qualified_name)),
...
def is_valid_find_code_rule(code: str, scheme_field: TableField, code_field: TableField, dataset=None):
    ...
    find_code_udf = IcdSnomedFindCodeIsValid if dataset in [
        DS.MHSDS, DS.MHSDS_V5, DS.MHSDS_V6, DS.IAPT_V2_1
...
def referential_integrity_using_is_valid_record_rule(
    ...
    """
    MHSDS, MHSDS_V5, MHSDS_V6, MSDS -specific referential integrity rule
