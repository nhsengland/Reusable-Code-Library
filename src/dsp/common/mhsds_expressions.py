...
from dsp.common.constants import mh_ethnic_category_codes
...
class NHSDLegalStatusExpression(ModelExpression):
    ...
    def resolve_value(self, model):
        ...
        if legal_status_code.zfill(2) in ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '12', '13', '14',
    ...
    def resolve_value(self, model):
        ...
        if rp_start_date and rp_end_date:
            commissioners = commissioners | set(
                ...
                for hpsc in hps.HospitalProviderSpellCommissioners
