...
from .sgss_enrich_mps import enrich_sgss_with_pds_mps
...
def test_enrich_sgss_with_pds_mps_and_pdscrosscheckcondition(spark: SparkSession):
    ...
    mps_response_data = [
        ('1:1', '', 'MPS_ID1', 4, Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0),
         '00', 'default'),
        ('1:2', '', '', 4, Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0), '00', 'j'),
        ('1:3', '9018954892', '', 1, Decimal(100.0), None, None, None, None, None, '00', 'k')
    ]
    ...
    pds_mps_df = spark.createDataFrame(spark.sparkContext.parallelize(mps_response_data),
                                       mps_response_schema_with_pdscrosscheckcondition)
    ...
    expected_data = [
        ('1:1', 'MPS_ID1', False, Decimal(0.0), '00', 'default'),
        ('1:2', 'U00005YC1U', False, Decimal(0.0), '00', 'j'),
        ('1:3', '9018954892', True, Decimal(100.0), '00', 'k')
    ]
    ...
    enriched_df = enriched_df.select('META.EVENT_ID', 'PERSON_ID', 'MPS_TRACE_SUCCESSFUL',
...
def test_enrich_sgss_with_pds_mps_and_no_pdscrosscheckcondition(spark: SparkSession):
    ...
    mps_response_data = [
        ('1:1', '', 'MPS_ID1', 4, Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0), '00'),
        ('1:2', '', '', 4, Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0), Decimal(0.0), '00'),
        ('1:3', '9018954892', '', 1, Decimal(100.0), None, None, None, None, None, '00')
    ]
    ...
    expected_data = [
        ('1:1', 'MPS_ID1', False, Decimal(0.0), '00'),
        ('1:2', 'U00005YC1U', False, Decimal(0.0), '00'),
        ('1:3', '9018954892', True, Decimal(100.0), '00')
    ]
    expected_df = spark.createDataFrame(spark.sparkContext.parallelize(expected_data), expected_schema)
