...
meta_dict = {
    ...
    'RECORD_INDEX': 0,
    'RECORD_VERSION': current_record_version(DS.IAPT),
}
...
def master_patient_index():
    return copy.deepcopy(master_patient_index_dict)
...
def care_personnel_qualification():
    return copy.deepcopy(care_personnel_qualification_dict)


def gp_practice_registration():
    return copy.deepcopy(gp_practice_registration_dict)
