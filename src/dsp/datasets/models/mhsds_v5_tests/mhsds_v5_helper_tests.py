...
provisional_diagnosis_dict = {
    'CodedProvDiagTimestamp': datetime(1981,10,28,6,6,24),
    'DiagSchemeInUse': '06',
    'ProvDiag': '47745005',
    'RowNumber': 1,
...
care_cluster_dict = {
    ...
    'ClustId': 'CTI00000000000000001',
    'EndDateCareClust': date(2018, 5, 28),
...
hospital_provider_spell_dict = {
    ...
    'DischDateHospProvSpell': date(2018, 5, 4),
...
@pytest.fixture(scope='function')
def hospital_provider_spell():
    yield copy.deepcopy(hospital_provider_spell_dict)
...
@pytest.fixture(scope='function')
def care_cluster():
    yield copy.deepcopy(care_cluster_dict)
