...
from dsp.datasets.models.uplift.msds.msd602.version_1 import schema as MSDS_V1
from dsp.datasets.models.uplift.msds.msd602.version_2 import schema as MSDS_V2
from dsp.datasets.models.uplift.msds.msd602.version_3 import schema as MSDS_V3, field_mapping as MSDS_V3_MAPPING
from dsp.datasets.models.uplift.msds.msd602.version_4 import schema as MSDS_V4
from dsp.datasets.models.uplift.msds.msd602.version_5 import schema as MSDS_V5
from dsp.datasets.models.uplift.msds.msd602.version_6 import schema as MSDS_V6
...
def v5_v6_uplift_decimal_fields(
    ...
    def uplift_row(row: Row) -> Row:
        ...
        msd602_id = row_dict['MSD602_ID']
        if msd000_id is not None:
            row_dict['Header']['MSD000_ID'] = Decimal(msd000_id)
        if msd602_id is not None:
            row_dict['MSD602_ID'] = Decimal(msd602_id)
