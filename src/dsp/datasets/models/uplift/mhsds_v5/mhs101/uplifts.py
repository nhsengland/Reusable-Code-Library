...
from dsp.datasets.models.uplift.mhsds_v5.mhs101.version_1 import schema as MHSDS_V5_V1
from dsp.datasets.models.uplift.mhsds_v5.mhs101.version_2 import schema as MHSDS_V5_V2, \
    fields_to_remove as MHSDS_V5_FIELDS_TO_REMOVE
from dsp.datasets.models.uplift.mhsds_v5.mhs101.version_3 import schema as MHSDS_V5_V3
from dsp.datasets.models.uplift.mhsds_v5.mhs101.version_4 import schema as MHSDS_V5_V4


def v2_v3_uplift_record_number(
        df: DataFrame,
        version_from: int,
        version_to: int,
    ...
    def uplift_row(row: Row) -> Row:
        ...
        record_number = row_dict['Patient']['RecordNumber']
        if record_number is not None:
            row_dict['Patient']['RecordNumber'] = Decimal(record_number)
...
UPLIFTS = {
    ...
    1: lambda df: simple_uplift(df, 1, 2, MHSDS_V5_V2,
                                fields_to_remove=frozenset(MHSDS_V5_FIELDS_TO_REMOVE)),
    2: lambda df: v2_v3_uplift_record_number(df, 2, 3, MHSDS_V5_V3),
