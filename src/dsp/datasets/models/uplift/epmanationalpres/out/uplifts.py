...
from dsp.datasets.models.uplift.epmanationalpres.out.version_2 import schema as EPMANATIONALPRES_V2


UPLIFTS = {
    1: lambda df: simple_uplift(df, 1, 2, EPMANATIONALPRES_V2,
                                ...
                                field_mapping={"ADDITIONAL_INSTRUCTIONS_SNOMED_CT_CHECK": "ADDITIONAL_INSTRUCTION_SNOMED_CT_CHECK",
                                               "ADDITIONAL_INSTRUCTIONS_SNOMED_CT_FILTERED": "ADDITIONAL_INSTRUCTION_SNOMED_CT_FILTERED"}),
}
