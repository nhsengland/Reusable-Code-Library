...
from dsp.datasets.models.uplift.mhsds.mhs101.version_1 import schema as MHSDS_V1
from dsp.datasets.models.uplift.mhsds.mhs101.version_2 import schema as MHSDS_V2
